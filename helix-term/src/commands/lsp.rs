...
fn display_symbol_kind(kind: lsp::SymbolKind, theme: &Theme) -> menu::Cell {
    match kind {
        ...
        lsp::SymbolKind::PACKAGE => menu::Cell::from("package"),
        lsp::SymbolKind::CLASS => menu::Cell::from("class"),
        ...
        lsp::SymbolKind::VARIABLE => menu::Cell::from("variable"),
        ...
        lsp::SymbolKind::OPERATOR => menu::Cell::from("operator"),
